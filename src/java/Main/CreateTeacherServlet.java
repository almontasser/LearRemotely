...
public class CreateTeacherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("action", "/create-teacher");

        Template.Header(req, resp, "إضافة أستاذ");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        DataAccess.executeUpdate("INSERT INTO Users (username, name, password, type) VALUES('"+username+"', '" + name + "', '" + password + "', 2);");
